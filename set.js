...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~srtgvLDcwV5g7kUOQCNd","PRINCE-MDX~mKCcFr2gMibV3mLB8bQH" // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "PRINCE-MDX~mKCcFr2gMibV3mLB8bQH", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
ANTI_DELETE: process.env.ANTI_DELETE || "inboxonly", // can be set to inboxonly/allchats/true/false
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "true",
AUTO_LIKE_EMOJIS: process.env.AUTO_LIKE_EMOJIS || "💛,❤️,💜,🤍,💙", //Input Yours Custom...Can be one Emoji or Multiple Emojis Separated by Commas
CUSTOM_REACT: process.env.CUSTOM_REACT || "true", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "🤍,💜,💛,🧡,🩵,💗", //Input Yours Custom...Can be one Emoji Or Multiple Emojis Separated by Commas
